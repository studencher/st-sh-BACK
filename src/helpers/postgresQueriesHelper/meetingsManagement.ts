export function getInsertMeetingQuery(): string{
...
export function getInsertUserMeetingQueries(): string{
    return `insert into user_meetings (user_id, meeting_id) VALUES ($1, $2)`
}

export function getSelectUserMeetingsQueries(): string{
...
export function getUpdateUserMeetingQuery(): string{
...
export function getUpdateMeetingQuery(): string{
...
export function getMeetingsQuery(): string{
