...
export class ChessTestsService {
    ...
    private static getPrintToScreenRegex(): RegExp {
    ...
    private static getNewPrintToScreenForAutoTest(): string {
...
export default new ChessTestsService(logger, dotNetProjectTestsService);
