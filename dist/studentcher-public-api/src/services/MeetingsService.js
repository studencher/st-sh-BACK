...
const DiscordService_1 = __importDefault(require("../../../studentcher-backend-shared-utils/src/services/DiscordService"));
const Logger_1 = __importDefault(require("../../../studentcher-backend-shared-utils/src/helpers/Logger"));
class MeetingsService {
    ...
    async addMeeting(data) {
        try {
            ...
            data.id = meetingId;
            await this.meetingsRepository.insertOne(data);
