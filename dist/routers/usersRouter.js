...
router.post("/activities", AuthenticationService_1.default.verify, AuthorizationService_1.default.verifyUserPermission(studentcher_shared_utils_1.Constants.permissions.userManagement), PostgresAdapter_1.userActivityTracker, AuthorizationService_1.default.verifyAccessToRole(), UsersController_1.default.addUserActivity);
...
router.get("/fixUsersMissingDetails", AuthenticationService_1.default.verify, AuthorizationService_1.default.verifyUserPermission(studentcher_shared_utils_1.Constants.permissions.appPanelEnabled), UsersController_1.default.fixUsersMissingDetails);
