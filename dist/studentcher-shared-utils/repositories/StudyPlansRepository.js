...
class StudyPlansRepository extends EntityRepository_1.EntityRepository {
    constructor() {
        super();
    ...
    async editOne(data) {
        ...
        if (response[0].rowCount === 0)
            throw new CustomError_1.CustomError("Study Plan not found.", 404);
    ...
    async deleteMany(data) {
        ...
        if (response.rowCount === 0)
            throw new CustomError_1.CustomError("Study plans not found.", 404);
